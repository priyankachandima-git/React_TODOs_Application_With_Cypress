 ...
 */
export function I_AddTodoItems(itemList, numberOfItemsNeeded)
{
...
/**
 * @param todoItemTitle : string of the given TODO item
 * @summary Remove given TODO item from the list
 */
export function I_RemoveTodoItemByTitle(todoItemTitle)
{
 ...
 */
export function I_MarkItemAsCompletedByTitle(todoItemTitle)
{
    GetIndexByItemTitle(todoItemTitle)
 ...
 */
export function I_ValidateItemIsCompletedByTitle(todoItemTitle){
    GetIndexByItemTitle(todoItemTitle)
 ...
 */
export function I_ValidateAllCompletedItemsGetFiltered_By_CompletedFilterOption(completedItemsCount){
    cy.get(todosFrontPages.MainScreen.TodoItems).each(($el, index, $list) =>{
            cy.wrap($el).should('have.class', 'completed')
 ...
 */
export function I_ValidateAllItemIsCompleted(){
    cy.get(todosFrontPages.MainScreen.TodoItems).each(($el, index, $list) =>{
        cy.wrap($el).should('have.class', 'completed')
    })
}
 ...
 */
export function I_ValidateNumberOfActiveItemMessage(numberOfActiveItems){
 ...
 */
export function I_ValidateTodoItemDoesNotExistByTitle(todoItemTitle){
    cy.get(todosFrontPages.MainScreen.TodoItemLabel).each(($el,index,$list) =>{
        if($el.text().toString() ==todoItemTitle){
